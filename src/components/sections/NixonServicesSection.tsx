...
export function NixonServicesSection() {
  return (
    <section className="bg-background py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mb-12 text-center lg:mb-16">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm text-foreground/70 lg:text-base">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="flex flex-col items-start text-center">
              <h4 className="w-full font-heading text-lg font-bold underline decoration-2 underline-offset-4">
                {service.title}
              </h4>
              <p className="mt-3 text-sm leading-relaxed text-foreground/70">{service.description}</p>
