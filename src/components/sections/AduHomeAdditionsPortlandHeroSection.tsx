...
interface AduHomeAdditionsPortlandHeroSectionProps {
  className?: string;
}

export function AduHomeAdditionsPortlandHeroSection({
  className,
}: AduHomeAdditionsPortlandHeroSectionProps) {
  return (
    <section className={cn("relative min-h-[90vh] overflow-hidden bg-foreground", className)}>
      <img
        src="/images/SW_78th_A1_d1e971d9.png"
